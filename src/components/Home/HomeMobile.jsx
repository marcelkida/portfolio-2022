...
import Work2Mobile from './Work2Mobile'
                        ...
                        <div className='home-text lg-mt-32 overflow-visible'>
                            ...
                            <motion.div className='title' id='change' variants={banner3} initial="initial" animate="animate" style={{ overflow: "visible" }} >
                                <motion.div variants={(isLoaded && animComp) ? letterAni2 : null} >I am a <span className='title-span'>
                                    {[..."creative"].map((letter) => (
                                        <motion.div className='inline-block pointer-events-auto' whileTap={{ translateY: -50, color: "blue" }}>
...
<div>
                                        {[..."developer"].map((letter) => (
                                            <motion.div className='inline-block pointer-events-auto' whileTap={{ scale: 2, color: "red" }}>
                    ...
                    <motion.div className='ghost-container overflow-visible relative' >
                        <Spline className='ghost overflow-visible relative' scene="https://prod.spline.design/8cUszwNNQXxO9RPr/scene.splinecode"
                            onLoad={onLoad} />
                    </motion.div>
